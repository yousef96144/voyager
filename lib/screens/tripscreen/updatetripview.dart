...
class UpdateTrips extends StatefulWidget{
      final  int tripId;
      final  String from;
      final  String to;
  ...
  State<StatefulWidget> createState() {
    ...
    class _UpdateTripsState extends State<UpdateTrips> {
      final  int tripId;
      final  String from;
      final  String to;
      final  String carModel;
  ...
  void initState() {
    ...
    messageController.text=description;
    _recentDate=DateTime.parse(tripDate);
    _recentTime=TimeOfDay.fromDateTime(DateTime.parse(tripDate));
      ...
      updateThisTrip(BuildContext context) async {
        setState(() {
          _isLoading = true;
        });
        ...
        var dateAfterMyFormat = _recentDate.add(Duration(
            hours: _recentTime.hour, minutes: _recentTime.minute, seconds: 0))
            .toString();
...
//          print(body["success"]);
          ...
          if (body["success"] == true) {
            Scaffold.of(context).showSnackBar(
                SnackBar(
                  content: Text("trip has been updated succefully"),
                ));
            setState(() {
              _isLoading=false;
            });
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        Icon(Icons.calendar_today,
                                          color: Color(0xFF839195), size: 20.0,),

                                        Text(
                                          _recentDate == null ? 'Date' : DateFormat
                                              .yMMMEd().format(_recentDate),
                                          style: TextStyle(
                                            fontFamily: 'Poppins',
                                            color: Color(0xFF839195),
                                            fontSize: 12,
...
//////////////////////////////////////////////////////////////////////////POST button
                ...
                Container(
                    ...
                    child: Material(
                      ...
                      elevation: 7.0,
                      child: MaterialButton(
                        onPressed: _isLoading ? null : ()=>updateThisTrip(context),
                        child: Text(
